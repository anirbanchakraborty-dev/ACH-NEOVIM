  ...
  -- which-key: popup keymap helper
  {
    ...
    opts = {
      ...
      spec = {
        ...
        { "<leader>bd", desc = "Delete Buffer",              icon = { icon = icons.diagnostics.Error, color = "red"    } },
        { "<leader>bD", desc = "Delete Buffer & Window",     icon = { icon = icons.diagnostics.Error, color = "red"    } },
        { "<leader>bo", desc = "Delete Other Buffers",       icon = { icon = icons.ui.close,          color = "grey"   } },
        { "<leader>bb", desc = "Switch to Other Buffer",     icon = { icon = icons.find.buffer,       color = "cyan"   } },
        { "<leader>`",  desc = "Switch to Other Buffer",     icon = { icon = icons.find.buffer,       color = "cyan"   } },
        -- Bufferline-owned buffer operations
        { "<leader>bp", desc = "Toggle Pin Buffer",          icon = { icon = icons.ui.pin,            color = "yellow" } },
        { "<leader>bP", desc = "Delete Non-Pinned Buffers",  icon = { icon = icons.ui.close,          color = "red"    } },
        { "<leader>br", desc = "Delete Buffers to the Right", icon = { icon = icons.misc.arrow_right, color = "orange" } },
        { "<leader>bl", desc = "Delete Buffers to the Left", icon = { icon = icons.misc.arrow_left,  color = "orange" } },
        { "<leader>bj", desc = "Pick Buffer",                icon = { icon = icons.ui.eye,            color = "cyan"   } },
        ...
        { "<leader>xx", desc = "Diagnostics (Trouble)",         icon = { icon = icons.find.diagnostic, color = "red"    } },
        { "<leader>xX", desc = "Buffer Diagnostics (Trouble)",  icon = { icon = icons.find.diagnostic, color = "red"    } },
        { "<leader>xL", desc = "Location List (Trouble)",       icon = { icon = icons.find.loclist,    color = "yellow" } },
        { "<leader>xQ", desc = "Quickfix List (Trouble)",       icon = { icon = icons.find.quickfix,   color = "yellow" } },
        { "<leader>xt", desc = "Todo (Trouble)",                icon = { icon = icons.plugins.todo,    color = "yellow" } },
